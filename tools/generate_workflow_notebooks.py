    ...
    create(
        ...
        [
            (
                ...
                "show_summary('Modo DeepSeek verificado',{'Flash':primary_probe['thinking'],'Pro':reviewer_probe['thinking']},tone='success')\n"
            ...
            (
                ...
                "    signature={'model':probe['model'],'thinking':probe['thinking'],'prompt_sha256':probe['prompt_sha256'],'operational_prompt_sha256':probe['operational_prompt_sha256'],'records_per_request':probe['records_per_request'],'label_source':probe['label_source']}\n"
                ...
                "    result=annotate_batched_incremental(rows,provider,output,error_path=output.with_suffix('.errors.jsonl'),limit=limit,processing_batch_size=PROCESSING_BATCH_SIZE,progress_callback=labeling_progress(description),checkpoint_callback=checkpoint_callback_for(output),checkpoint_every_batches=DRIVE_CHECKPOINT_EVERY_BATCHES,run_metadata=run_metadata,quarantine_invalid_progress=True)\n"
