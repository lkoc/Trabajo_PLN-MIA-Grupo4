...
Mantenga esa terminal abierta y visite <http://127.0.0.1:8765>. La interfaz empieza en **Urgentes** (cola corta de conflictos); puede cambiar a **Prioritarios Pro** (Pro sin resolver o con daño), **Todos** o **Excluidos** desde la barra superior. **Excluidos** reúne los chunks fuera del dataset entrenable y permite reclasificarlos.
