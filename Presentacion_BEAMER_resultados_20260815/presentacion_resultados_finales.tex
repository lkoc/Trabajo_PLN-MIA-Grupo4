...
\begin{frame}[shrink=8]{Metodología del ensemble optimizado}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{.47\textwidth}
      \smallcard{Teal}{Fusión suave}{Cada score se calibra dentro del pliegue; los pesos no negativos suman uno.}
    \end{column}
    \begin{column}{.47\textwidth}
      \smallcard{Purple}{Optimización anidada}{5 pliegues externos e internos por vídeo; grid 0,025 con 861 ternas.}
    \end{column}
  \end{columns}
  \takeaway{Se optimizan todas las mezclas parametrizadas; unión e intersección no reciben coeficientes artificiales.}
  \externalNote{Diversidad y voto~\cite{dietterich2000ensemble,lam1997majority}; combinación aprendida~\cite{wolpert1992stacked,vanderlaan2007superlearner}; objetivo lexicográfico: propuesta propia.}
\end{frame}
...
\begin{frame}[shrink=7]{Criterio de selección y análisis estadístico}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
  \end{columns}
  \takeaway{El suave optimizado es el único seleccionado; frente al ponderado, $\Delta$BA=+0,00059$, IC95\,\% $[-0,00367;0,00509]$, $p=0,804$: ventaja inconclusa.}
