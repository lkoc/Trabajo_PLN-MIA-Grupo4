...
\node[lane] at (-1.75,1.05) {Evidencia y anotación};
...
\node[label] (annotation) at (18,0) {Anotación};
...
\draw[relation] (chunk.east)--node[edgeword,above]{anota}(annotation.west);
...
\draw[relation] (annotation.south)--node[edgeword,right]{clasifica}(concept.north);
