...
\node[evidence,below=6mm of p1] (e1) {Corpus v2.1\\173\,240 chunks};
...
\node[below=1mm of e3,align=center,text width=.95\textwidth] {\textit{Las iteraciones anteriores informan el diseño; solo los artefactos v2.1 sustentan los resultados vigentes.}};
\end{tikzpicture}
