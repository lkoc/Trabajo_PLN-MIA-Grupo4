\appendices
\onecolumn
\input{secciones/anexo_a_prompt}

\clearpage
\input{secciones/anexo_b_ejemplos}
...
\begin{figure}[H]
\centering
\resizebox{0.99\linewidth}{!}{\input{figuras/ontologia_trazabilidad.tex}}
...
SEGURO & En el baseline fue un estado derivado; en el contrato v2 es una quinta salida aprendida y exclusiva. & La migración histórica solo la asigna si existe una decisión segura explícita; no prueba ausencia universal de daño. \\
...
\input{secciones/anexo_d_canales}
\endgroup
...
Los datos, cuadernos y scripts pueden recuperarse desde esos repositorios manteniendo la estructura de carpetas documentada. Los artefactos de mayor tamaño se conservan en Drive; el flujo activo se ejecuta en orden desde \path{flujo/01_datos/} hasta \path{flujo/04_produccion/}, mientras el cuaderno 05 anterior permanece archivado. La accesibilidad técnica no concede por sí sola permiso de reutilización: deben comprobarse las licencias de modelos y herramientas, los términos de YouTube, la privacidad y los derechos sobre los subtítulos \cite{youtube2023terms,aoir2020ethics}.
