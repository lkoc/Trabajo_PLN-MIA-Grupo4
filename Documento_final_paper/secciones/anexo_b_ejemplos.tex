...
Como \texttt{SEGURO} se deriva al no activar ningún daño, se exigieron referencia segura y cuatro scores bajo umbral, y se ordenó por el menor margen \(\min_k(\theta_k-s_k)\). El valor mostrado es \(1-\max_k s_k\), no una probabilidad calibrada por una cabeza segura.
