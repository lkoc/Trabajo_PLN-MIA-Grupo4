...
En el baseline ilustrado, \texttt{SEGURO} se derivaba al no activar ningún daño: se exigieron referencia segura y cuatro scores bajo umbral, y se ordenó por el menor margen \(\min_k(\theta_k-s_k)\). El valor mostrado es \(1-\max_k s_k\), no una probabilidad calibrada por una cabeza segura. Esta construcción no representa la quinta salida aprendida del contrato v2.
