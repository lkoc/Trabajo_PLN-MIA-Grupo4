...
El texto siguiente es una transcripción estructurada y completa del prompt histórico v1.1, preservado en \path{archivo/contrato_4_danos_seguro_derivado/03_2_etiquetado_llm_api/}. Una copia idéntica reside en el archivo de la implementación local anterior. El prompt declara que compila la guía, las instrucciones de transporte y la taxonomía; acredita las corridas históricas, no el contrato v2.
