...
El texto siguiente es una transcripción estructurada y completa del prompt histórico preservado en los materiales de trazabilidad. El prompt declara que compila la guía, las instrucciones de transporte y la taxonomía; acredita las corridas históricas, no el contrato final.
...
\subsection*{Composición y alcance acreditado}

El proceso antepone la identidad del clasificador, inserta este prompt y la taxonomía completa, y añade reglas para lotes, salida estructurada, orden de identificadores, vocabulario literal y límites de longitud. La llamada usa temperatura 0 y razonamiento desactivado. Los manifiestos de los lotes etiquetados mediante la API registran el prompt utilizado. Este prompt guía el etiquetado y no forma parte de la entrada textual del clasificador Qwen3--LoRA.
