...
- Etiquetado: documentación oficial de DeepSeek V4, su tabla de precios, Qwen y
  Colab, junto con evidencia sobre anotación asistida, selección dirigida,
  contexto y acuerdo. La proyección económica se identifica como cálculo local
  sobre consumo histórico y no como resultado garantizado por el proveedor.
...
Resultado: 108 pruebas aprobadas; 18/18 cuadernos con celda final; 101/101
...
auditor del proyecto. La comprobación estructural admite salidas guardadas
únicamente en `01_03`, que conserva deliberadamente los resultados descriptivos
del usuario para reporting; los otros 17 cuadernos activos están limpios.
