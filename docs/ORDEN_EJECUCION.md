...
| 2 | `01_015_ampliacion_dirigida_minorias` | decisión efectiva + déficit por daño en train | candidatos nuevos dirigidos con split estable | opcional; meta ≥2.000 chunks por daño en train, sin alterar `01_01` |
...
- `01_015` se usa solo para la ampliación minoritaria. Parte de 1.826 chunks de racismo/discriminación y 1.568 de ataque por género/identidad en `train`, pondera déficits de 174 y 432, y reserva candidatos 450/80/80 para train/validation/test mediante SHA-256 del `video_id`. Después de etiquetar, vuelva a ejecutarlo para comprobar si ya se alcanzó la meta de 2.000.
