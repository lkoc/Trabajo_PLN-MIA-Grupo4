...
| 5 | `02_01_etiquetado_local_ollama` | chunks actuales + etiquetado DeepSeek histórico | recuperación exacta 1:1, calibración Flash–Pro, primera pasada Flash y revisión Pro dirigida | firma + `chunk_id`, fsync por grupo de 5, checkpoint Drive periódico/al interrumpir, cuarentena y tope de costo |
