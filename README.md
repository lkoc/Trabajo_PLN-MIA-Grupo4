...
| `01_02` | el resultado clásico se reutiliza, `RUN_NEURAL_ROBUST_TEST=True`, `USE_ROBUST_RECOMMENDATION=True` y `APPLY_CHUNK_SELECTION=False` | ejecuta o reanuda 25 cabezas MiniLM y 500 respuestas Ollama sobre las cinco longitudes; al terminar muestra las tres familias y conserva la decisión clásica salvo activación manual explícita |
