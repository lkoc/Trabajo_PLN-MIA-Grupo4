...
Versión del prompt: **3.0.0**  
Contrato y taxonomía: **`moderacion_peru_5_salidas_v2`, versión 2.1.0**

Este prompt sucede, pero no reemplaza ni borra,
`config/prompt_operacional_ollama_v2.md`. Incorpora los errores y casos límite
observados en la auditoría estratificada y en la búsqueda dirigida del corpus
peruano de agosto de 2026. La autoridad normativa continúa siendo
