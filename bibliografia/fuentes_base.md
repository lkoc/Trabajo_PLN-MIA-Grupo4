...
| `brodersen2010balanced` | Balanced accuracy como promedio del desempeño por clase ante desbalance. | No determina los costos sociales locales ni sustituye el análisis multietiqueta. | [IEEE](https://doi.org/10.1109/ICPR.2010.764) |
| `elkan2001cost` | Decisión y aprendizaje cuando los errores tienen costos distintos. | No proporciona una matriz de costos para moderación ni estima el costo humano de revisión. | [UC San Diego](https://cseweb.ucsd.edu/~elkan/rescale.pdf) |
...
| `mozannar2020defer` | Marco para aprender cuándo predecir o derivar la decisión a un experto. | El proyecto deriva por reglas posteriores y todavía no aprende un predictor del desempeño humano. | [PMLR](https://proceedings.mlr.press/v119/mozannar20b.html) |
| `holm1979multiple` | Corrección secuencial para controlar el error familiar en múltiples contrastes. | No selecciona la métrica, el agrupamiento ni la prueba apropiada para el corpus. | [DOI](https://doi.org/10.2307/4615733) |
| `jin2008pareto` | Selección de aprendizaje automático con objetivos múltiples y soluciones no dominadas. | No fija preferencias, pesos ni costos para este moderador; deben declararse localmente. | [DOI](https://doi.org/10.1109/TSMCC.2008.919172) |
