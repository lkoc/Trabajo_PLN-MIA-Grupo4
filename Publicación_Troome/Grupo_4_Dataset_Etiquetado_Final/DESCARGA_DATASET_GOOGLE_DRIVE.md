...
El dataset documentado se conserva en Google Drive porque el JSON sin comprimir
supera el límite de tamaño de GitHub:
...
El paquete también contiene `README.md`, `dataset_schema.json`,
`MANIFEST.sha256`, `PROVENANCE.md`, `CITATION.cff`, el informe de validación y
el script `validar_dataset.py`. El acceso puede requerir autorización del
propietario de la carpeta de Drive.
